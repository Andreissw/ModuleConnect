...
namespace ModuleConnect
{
    public class Class1
    {
        ...
        static public void loadgridOmron(DataGridView grid, string cmd) //Достает с базы PSIGMA FLAT и преобразует в грид, таблицу
        {
            try
            {
                SqlConnection sqlcon = new SqlConnection(@"Data Source= 192.168.37.100\orprovision; Initial Catalog= ; User Id = volodin; Password = kjifhf123;");
        ...
        static public void loadgrid(DataGridView grid, string cmd) //Достает с базы PSIGMA FLAT и преобразует в грид, таблицу
        {
            ...
            try
            {
                SqlConnection sqlcon = new SqlConnection(@"Data Source= traceability\flat; Initial Catalog= ; User Id = volodin; Password = volodin;");
                SqlCommand c = new SqlCommand();
                SqlDataAdapter da = new SqlDataAdapter();
                DataSet ds = new DataSet();
                sqlcon.Open();
        ...
        static public object SelectStringOraString(string cmd)//Достает с базы ОРАКЛ текстовое значение 
        ...
        static public object SelectStringOraInteger(string cmd) //Достает с базы ОРАКЛ значение целого числа
        ...
        static public void LoadGridOra(DataGridView Grid, string cmd)
